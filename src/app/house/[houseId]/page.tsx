    ...
    >
      ...
      <div className="relative z-10 min-h-screen p-8">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="bg-gradient-to-r from-red-800 to-orange-800 rounded-2xl p-8 mb-8 border-4 border-yellow-600 shadow-2xl flex justify-between items-center">
            <div>
          ...
          {/* Treasury */}
          <div className="bg-black bg-opacity-40 rounded-xl p-6 border-2 border-yellow-500 mb-8">
          ...
          {activeRound && currentParticipant ? (
            <>
              {/* Round Info */}
              <div className="bg-gradient-to-br from-yellow-600 to-orange-700 rounded-2xl p-8 border-4 border-yellow-400 shadow-2xl mb-8 flex justify-between items-center">
              ...
              {/* Participant */}
              <div className="bg-black bg-opacity-80 rounded-2xl p-8 border-4 border-yellow-600 shadow-2xl mb-8 flex gap-8">
                <div className="relative">
                  {currentParticipant.picture ? (
                    ...
                    <div className="w-48 h-48 bg-gray-700 rounded-full border-8 border-yellow-400 flex items-center justify-center">
            ...
            <div className="bg-black bg-opacity-80 rounded-2xl p-12 border-4 border-yellow-600 shadow-2xl text-center">
